...
const timer = setInterval(function () {
  ...
  setTimeout(() => {
    ...
    comboChart = echarts.init(document.getElementById('userData')as HTMLElement)
    changeBatteryChart = echarts.init(document.getElementById('batteryData')as HTMLElement)
