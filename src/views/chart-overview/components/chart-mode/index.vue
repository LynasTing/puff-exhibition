...
import EChartMapCopy from '@/views/chart-overview/components/chart-mode/EchartMapCopy.vue'
import EChartMap from '@/views/chart-overview/components/chart-mode/EchartMap.vue'
...
const todayData = ref([
  { label: '今日耗电量', number: 268555 },
  { label: '今日收益总额', number: 268555 },
  { label: '今日使用用户量', number: 268555 },
  { label: '今日换电量', number: 268555 },
])
</script>
  ...
  <main class="text-white mx-5 mt-10 flex-1 flex flex-col">
    ...
    <ul class="flex today-data justify-between">
      <li class="flex items-center pl-5 pr-6 pt-8 pb-8 rounded-xl">
        <img src="`/imgs/mid-top-1.png`" class="w-10 h-10 mr-4">
        <div>
          <div>
            <span class="today-num">{{ largeScreen.statisticToday.electricity || 0 }}</span>
      ...
      <li class="flex items-center pl-5 pr-6 pt-8 pb-8 rounded-xl">
        <img src="`/imgs/mid-top-2.png`" class="w-10 h-10 mr-4">
        <div>
          <div>
            <span class="today-num">{{ largeScreen.statisticToday.incomeTotal || 0  }}</span>
            <i class="not-italic text-sm ">元</i>
          </div>
      ...
      <li class="flex items-center pl-5 pr-6 pt-8 pb-8 rounded-xl">
        <img src="`/imgs/mid-top-3.png`" class="w-10 h-10 mr-4">
        <div>
          <div>
            <span class="today-num">{{ largeScreen.statisticToday.userActive || 0  }}</span>
            <i class="not-italic text-sm ">元</i>
          </div>
      ...
      <li class="flex items-center pl-5 pr-6 pt-8 pb-8 rounded-xl">
        <img src="`/imgs/mid-top-4.png`" class="w-10 h-10 mr-4">
        <div>
          <div>
            <span class="today-num">{{ largeScreen.statisticToday.exchangCount }}</span>
            <i class="not-italic text-sm ">元</i>
          </div>
